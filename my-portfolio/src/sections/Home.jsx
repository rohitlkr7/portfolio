      ...
      <section id="Home" className=" w-full h-screen bg-black overflow-hidden relative">
        ...
        <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
          <div className=" flex flex-col justify-center h-full  text-center  lg:text-left relative">
            <div className="  lg:ml-16 w-full lg:pr-24  max-w-3xl">
              <motion.div
                className="mb-3 text-xl sm:text-5xl md:text-3xl lg:text-3xl font-semibold text-white tracking-wide min-h-[1.6rem]"
              ...
              <motion.h1
                className="text-4xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-transparent bg-clip-text
              ...
              >
                ...
                React, Node.js, Express, and MongoDB. Builds responsive UIs and
                REST APIs. Fast learner with strong problem-solving skills,
